...
def retrieval_qa_pipline(device_type, use_history, promptTemplate_type="llama"):
    ...
    # load the llm pipeline using the new HuggingFace-based loader
    # from load_models import load_model_auto
    # llm = load_model_auto(
    #     model_id=MODEL_ID,
...
@click.option(
    ...
    help="Device to run on. (Default is auto - detects best available device)",
)
@click.option(
    "--show_sources",
    "-s",
