...
CONTEXT_WINDOW_SIZE = 4096  # Reduced for better performance 
MAX_NEW_TOKENS = 2048  # Conservative setting

#### Device-Agnostic Settings
# Optimized for CPU, CUDA, and MPS (Mac Metal) devices:
N_GPU_LAYERS = 1  # Conservative GPU acceleration (auto-adjusted per device)
N_BATCH = 512

### Memory-optimized settings for different configurations
# Low memory (8-16GB RAM): N_GPU_LAYERS = 1, N_BATCH = 512
# Medium memory (32GB+ RAM): N_GPU_LAYERS = 35, N_BATCH = 1024
# High memory (64GB+ RAM): N_GPU_LAYERS = 50, N_BATCH = 2048
...
# Device-Agnostic Model Selection (Non-gated, auto-downloads)
...
# Device-Agnostic Model Selection
# All models below are tested to work on CPU, CUDA, and MPS (Mac) devices

# Current Selection: Microsoft DialoGPT-medium (Non-gated, auto-downloads)
# Good balance of performance and resource usage

# Alternative Options (uncomment to use):

# Option 1: GPT-2 (Reliable fallback, works everywhere)
# MODEL_ID = "gpt2"
# MODEL_BASENAME = None
...
# Option 3: TinyLlama (Small but capable, perfect for testing)
# MODEL_ID = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
# MODEL_BASENAME = None

# Option 4: GGUF Quantized Model (Requires HuggingFace download - better performance)
# MODEL_ID = "TheBloke/Llama-2-7B-Chat-GGUF"
# MODEL_BASENAME = "llama-2-7b-chat.Q4_K_M.gguf"

# Option 5: Llama 3 8B (Gated model - requires HuggingFace authentication)
